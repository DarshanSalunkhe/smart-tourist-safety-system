  ...
  setTimeout(() => {
    ...
    form?.addEventListener('submit', async (e) => {
      ...
      try {
        ...
        errorDiv.textContent = error.message || i18n.t('invalid_credentials');
    ...
    <div class="auth-container">
      <div class="auth-card">
        <div class="auth-header">
          ...
          <h1>Welcome back</h1>
          <p>Sign in to SafeTrip Safety System</p>
        </div>

        <div id="errorMessage" class="alert-msg error" style="display:none;"></div>

        <button id="googleLoginBtn" type="button" class="btn-google">
